...
//***My note: Testing problem 2 with Implicit return
let jsNinjaTest = () => console.log('I am a JavaScript ninja!') 
jsNinjaTest ()
...
let bestMovie = moviestr => `${moviestr} is the best movie ever!`
...
emailCheck('nanaabena24@gmail.com')
////////////////// PROBLEM 19 ////////////////////
/*
...
let totalFrogs = chocolateFrogs(7)
...
//CODE HERE
function chocolateFrogs2(goldCoins2){
  return (goldCoins2 / 3)
}

let totalFrogs2 = Math.floor(chocolateFrogs2(7))
...
function checkAscending(arr){
  let arrayValue = arr[0] //the starting position
  for(let i = 1; i<arr.length; i++){// starting at 1
    if(arr[i] <= arrayValue) {//the starting position 1 is less than 0
    return false
    } else{
    arrayValue = arr[i]
    }
